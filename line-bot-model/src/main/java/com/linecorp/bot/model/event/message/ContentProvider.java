...
public class ContentProvider {
    ...
    @JsonCreator
    public ContentProvider(@JsonProperty("type")String type,@JsonProperty("originalContentUrl") String originalContentUrl,@JsonProperty("previewImageUrl") String previewImageUrl) {
        this.type = type;
